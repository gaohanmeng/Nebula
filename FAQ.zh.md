...
**A:** ❌ **暂时不行！** Nebula RPA 客户端目前仅支持 Windows 系统。
...
# 2. 复制到客户端安装目录
# 从：\*-rpa\engine\shared\astronverse-workflowlib\src\astronverse\workflowlib
# 复制到：C:\Program Files\Nebula RPA\data\python_core\Lib\site-packages\astronverse\workflowlib
```
