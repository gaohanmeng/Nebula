!macro customInstall
    ...
    WriteRegStr HKCR "astronrpa" "FriendlyTypeName" "Nebula RPA"
    WriteRegStr HKCR "astronrpa\Application" "ApplicationName" "Nebula RPA"
    ...
    ${If} ${Errors}
        ...
        WriteRegStr HKCU "Software\Classes\astronrpa" "FriendlyTypeName" "Nebula RPA"
        WriteRegStr HKCU "Software\Classes\astronrpa\Application" "ApplicationName" "Nebula RPA"
